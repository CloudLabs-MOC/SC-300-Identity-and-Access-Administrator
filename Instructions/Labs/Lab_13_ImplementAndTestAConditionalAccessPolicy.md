...
6. Within the new policy page, configure the following:
    ...
    - Under **Assignments**, click on **Users or agents (2)**.
    - Within the **Include** tab, ensure to choose **Select users and groups (3)** radio button.
    - Select the **Users and groups (4)** checkbox.
    - Under **Select**, click on **0 users and groups selected** to add the new user who would be alligned to this conditional access policy.
